...
await build({absWorkingDir:root,entryPoints:['coffee-terminal/web/twin/devices/app.mjs'],outfile:'coffee-terminal/web/device-lab.bundle.js',loader:{'.svg':'text'},bundle:true,minify:true,format:'esm',target:['es2022'],legalComments:'eof'});
